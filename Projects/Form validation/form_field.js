class FormField {
  constructor(
    formFieldSelector,
    { minlength = 5, maxlength = 100, errorMsgSelector, matchWithPasswordId }
  ) {
  ...
  checkValidPassword = () => {
    if (!this.matchWiDthPasswordId) return true;
    const matchWith = document.querySelector(this.matchWidthPasswordId);
